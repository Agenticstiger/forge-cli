...
:class:`~fluid_build.cli.forge_copilot_llm_providers.LlmProvider` with **no core
...
def _reserved_builtin_names() -> frozenset:
    ...
    """
    from fluid_build.cli.forge_copilot_llm_providers import BUILTIN_LLM_PROVIDERS

...
class CopilotAgentBase(CopilotProjectMemoryMixin, CopilotLegacyScaffoldMixin, AIAgent):
    ...
    def _create_forge_config(
        ...
        if generation_result:
            ...
            # Audit trail: stamp the active prompt profile + overlay stack (if
            # any) into the generated contract's provenance before it becomes
            # the write payload. Single chokepoint shared with the blank/guided
            # path.
            ...
            stamp_prompt_overlays(generation_result.contract)

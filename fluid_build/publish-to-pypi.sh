...
main() {
    ...
    echo -e "  pip install --index-url http://${NAS_HOST:-localhost}:${PYPI_PORT:-8080}/simple data-product-forge==$(generate_version experimental) # Experimental"
    echo -e "  pip install --index-url http://${NAS_HOST:-localhost}:${PYPI_PORT:-8080}/simple data-product-forge==$(generate_version alpha)        # Alpha"
    echo -e "  pip install --index-url http://${NAS_HOST:-localhost}:${PYPI_PORT:-8080}/simple data-product-forge==$(generate_version beta)         # Beta"
    echo -e "  pip install --index-url http://${NAS_HOST:-localhost}:${PYPI_PORT:-8080}/simple data-product-forge==$(generate_version stable)       # Stable"
    echo ""
